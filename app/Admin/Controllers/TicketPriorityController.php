...
class TicketPriorityController extends Controller
{
    ...
    public function edit($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            ...
            $content->breadcrumb(
                ['text' => 'Öncelikler', 'url' => admin_url('ticketpriority')],
                ['text' => 'Öncelik Ekle']
            );
    ...
    {
        return Admin::grid(TicketPriorityModel::class, function (Grid $grid) {
    ...
    {
        return Admin::form(TicketPriorityModel::class, function (Form $form) {
