...
class PaymentTypeController extends Controller
{
    ...
    public function edit($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            ...
            $content->breadcrumb(
                ['text' => 'Ödeme Tipleri', 'url' => admin_url('paymenttypes')],
                ['text' => 'Ödeme Düzenle']
            );
    ...
    {
        return Admin::grid(PaymentTypeModel::class, function (Grid $grid) {
            ...
            $grid->name('Ödeme Tipi')->editable('textarea')->sortable();
    ...
    {
        return Admin::form(PaymentTypeModel::class, function (Form $form) {
            ...
            $form->text('name', 'Ödeme Tipi')->rules('required')->setWidth(4);
