    ...
    function Head(editor) {
        ...
        this.droplist = new DropList(this, {
            ...
            list: [{$elem: $('<h1>H1</h1>'), value: '<h1>'}, {
                ...
                $elem: $('<h4>H4</h4>'),
                value: '<h4>'
            }, {$elem: $('<h5>H5</h5>'), value: '<h5>'}, {$elem: $('<p>Metin</p>'), value: '<p>'}],
...
*/
    ...
    function List(editor) {
        ...
        this.droplist = new DropList(this, {
            ...
            type: 'list',
            list: [{
                $elem: $('<span><i class="w-e-icon-list-numbered"></i> Sıralı Liste</span>'),
                value: 'insertOrderedList'
            }, {$elem: $('<span><i class="w-e-icon-list2"></i> Sırasız Liste</span>'), value: 'insertUnorderedList'}],
            onClick: function onClick(value) {
                _this._command(value);
            }
        });
...
// 构造函数
    function Justify(editor) {
        ...
        this.droplist = new DropList(this, {
            ...
            type: 'list', // droplist 以列表形式展示
            list: [{
                $elem: $('<span><i class="w-e-icon-paragraph-left"></i> Sola Yasla</span>'),
                value: 'justifyLeft'
            }, {
                $elem: $('<span><i class="w-e-icon-paragraph-center"></i> Ortalı</span>'),
                value: 'justifyCenter'
            }, {$elem: $('<span><i class="w-e-icon-paragraph-right"></i> Sağa Yasla</span>'), value: 'justifyRight'}],
            onClick: function onClick(value) {
    ...
    Code.prototype = {
        ...
        _createPanel: function _createPanel(value) {
            ...
            var panel = new Panel(this, {
                ...
                tabs: [{
                    title: 'Kod Ekle',
                    tpl: '<div>\n                        <textarea id="' + textId + '" style="height:145px;;">' + value + '</textarea>\n                        <div class="w-e-button-container">\n                            <button id="' + btnId + '" class="right">Ekle</button>\n                        </div>\n                    <div>',
                    events: [
                        {
                            selector: '#' + btnId,
                            type: 'click',
        ...
        _createInsertPanel: function _createInsertPanel() {
            ...
            var panel = new Panel(this, {
                ...
                tabs: [{
                    ...
                    title: 'Tablo Ekle',
                    // 模板
                    tpl: '<div>\n                        <p style="text-align:left; padding:5px 0;">\n                            Satır\n                            <input id="' + textRowNum + '" type="text" value="5" style="width:40px;text-align:center;"/>\n                            Sütun\n                            <input id="' + textColNum + '" type="text" value="5" style="width:40px;text-align:center;"/>\n                                                 </p>\n                        <div class="w-e-button-container">\n                            <button id="' + btnInsertId + '" class="right">Ekle</button>\n                        </div>\n                    </div>',
                    // 事件绑定
                    events: [{
                        // 点击按钮，插入表格
    ...
    Video.prototype = {
        ...
        _createPanel: function _createPanel() {
            ...
            var panel = new Panel(this, {
                ...
                tabs: [{
                    title: 'Video Ekle',
                    tpl: '<div>\n                        <input id="' + textValId + '" type="text" class="block" placeholder="<iframe src=... ></iframe>"/>\n                        <div class="w-e-button-container">\n                            <button id="' + btnId + '" class="right">Ekle</button>\n                        </div>\n                    </div>',
                    events: [{
                        selector: '#' + btnId,
                        type: 'click',
                        fn: function fn() {
    ...
    Image.prototype = {
        ...
        _createInsertPanel: function _createInsertPanel() {
            ...
            var tabsConfig = [{
                ...
                {
                    title: 'Bağlantı Ekle',
                    tpl: '<div>\n                    <input id="' + linkUrlId + '" type="text" class="block" placeholder="Resmin Bağlantısı"/></td>\n                    <div class="w-e-button-container">\n                        <button id="' + linkBtnId + '" class="right">Ekle</button>\n                    </div>\n                </div>',
                    events: [{
                        selector: '#' + linkBtnId,
                        type: 'click',
                        fn: function fn() {
    ...
    UploadImg.prototype = {
        ...
        insertLinkImg: function insertLinkImg(link) {
            ...
            img.onerror = function () {
                img = null;
                // 无法成功下载图片
                _this2._alert('Resim ekleme hatası', 'wangEditor: \u63D2\u5165\u56FE\u7247\u51FA\u9519\uFF0C\u56FE\u7247\u94FE\u63A5\u662F "' + link + '"\uFF0C\u4E0B\u8F7D\u8BE5\u94FE\u63A5\u5931\u8D25');
                return;
            };
