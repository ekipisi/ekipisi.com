...
(function($) {
	...
	$.fn.fileuploader.defaults = {
        ...
        captions: {
            button: function(options) { return 'Gözat ' },
            feedback: function(options) { return 'Yüklemek istediğiniz dosyalar'; },
            feedback2: function(options) { return options.length + ' ' + (options.length > 1 ? ' dosya' : ' dosya') + ' seçildi.'; },
			confirm: 'Doğrula',
            cancel: 'İptal',
			name: 'Name',
			type: 'Type',
